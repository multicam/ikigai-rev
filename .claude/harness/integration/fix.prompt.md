...
You have ONE job: fix the failing integration test. Do not refactor unrelated code.
...
1. Append a brief summary to `.claude/harness/integration/history.md` describing:
   - What you tried
