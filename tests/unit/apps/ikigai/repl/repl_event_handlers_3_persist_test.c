 ...
 *
 * Tests for coverage gaps in persist_assistant_msg with various
 * thinking levels and provider information.
 */
...
static Suite *repl_event_handlers_persist_suite(void)
{
...
{
    int number_failed;
    Suite *s = repl_event_handlers_persist_suite();
    SRunner *sr = srunner_create(s);
    srunner_set_xml(sr, "reports/check/unit/apps/ikigai/repl/repl_event_handlers_3_persist_test.xml");
