...
static Suite *history_edge_cases_suite(void)
{
...
int main(void)
{
    Suite *s = history_edge_cases_suite();
    SRunner *sr = srunner_create(s);
    srunner_set_xml(sr, "reports/check/integration/apps/ikigai/history_edge_cases_test.xml");
